...
public class Generate_Starfield : Node
{
    ...
    protected internal override void NodeGUI()
    {
        ...
        Variable3 = GUILayout.HorizontalSlider(Variable3, 0, 20f);
        
        GUILayout.Label("Size (0 to 16) " + Variable4.ToString("0.00"));
        Variable4 = GUILayout.HorizontalSlider(Variable4, 0.01f, 16);
        
        GUILayout.Label("Speed -100/100: " + Variable5.ToString("0.00"));
        Variable5 = GUILayout.HorizontalSlider(Variable5, -100, 100);
